...
<body>
	...
	<form action="all" method="get" class="form-inline" name="searchForm">
		<div class="form-group mx-sm-3 mb-2">
			<input type="text" name="search-good" class="form-control"
				id="inputPassword2" placeholder="Название товара">
		</div>
	...
	<script>
		function myFunction() {
			alert("Вы приобрели товар! Давайте деньги)");
		}
		search();
		function search() {
	<%if (list.isEmpty()) {%>
		alert("Товар под таким название не найден");
	<%}%>
		}
	</script>
